...
const ArtistDetails = () => {
    return (
        <motion.div
            ...
            className='flex flex-col items-center justify-center border-2 border-green-500 shadow-sm drop-shadow-3xl rounded-md shadow-green-400 px-8 py-4 bg-black backdrop-blur-lg'
        >
